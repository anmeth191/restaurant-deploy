...
class Footer extends React.Component{
 ...
 //this function gets the time from the computer and virifies if the shop is open or is closed
checkSchedule = ()=>{
//start a new Date variable
...
//then looks for the days in this case use the state days and then check the time interval and sets a result to display
